          ...
          <div className="container mx-auto text-center relative z-10">
            <div className="mb-4 sm:mb-6">
              <span className="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-gradient-to-r from-[#e0eaff] to-[#c7e0ff] text-[#002147] text-sm sm:text-base font-semibold shadow-md">
                <DollarSign className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-[#002147]" />
                Transparent Pricing
              </span>
            </div>
        ...
        <section className="py-12 sm:py-16 px-4 sm:px-6 bg-white">
          <div className="container mx-auto">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#111827] mb-3 sm:mb-4">Shipping Rates</h2>
